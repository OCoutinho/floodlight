...
public interface ILoadBalancerService extends IFloodlightService {
	...
	L7Policy createL7Policy(L7Policy l7_policy);

	L7Policy updateL7Policy(L7Policy l7_policy);

	Collection<L7Policy> listL7Policies();

	int removeL7Policy(String policyId);

	Collection<L7Policy> listL7Policy(String policyId);

	int removeL7Rule(String ruleId);

	Collection<L7Rule> listL7Rule(String ruleId);

	Collection<L7Rule> listL7Rules();
